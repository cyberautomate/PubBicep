...
`onPremVirtualNetworkAddressPrefix` | '10.0.121.0/26' | The CIDR Virtual Network Address Prefix for the On-Prem Virtual Network.
`onPremSubnetAddressPrefix` | '10.0.121.0/27' | The CIDR Subnet Address Prefix for the default On-Prem subnet. It must be in the On-Prem Virtual Network space.
